-- GalaxyHub standalone UI test #9
...
local source = [===[--[[ GalaxyHub | BloxFruit | FILE 8: Race V2/V3/V4 ]]
local Players = game:GetService("Players")
