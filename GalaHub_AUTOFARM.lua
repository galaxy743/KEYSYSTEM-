...
v485:AddToggle({
    ...
    Description = "Tự nhận nhiệm vụ • tìm quái • gom quái • đánh nhanh • cày cấp",
    Default = false,
...
v485:AddToggle({
    Name = "Fast Attack",
    Description = "Đánh nhanh các quái trong phạm vi",
    Default = false,
    Callback = function(state)
        _G.AutoAttack = state
    end
...
v485:AddToggle({
    Name = "Hit All Mobs",
    Description = "Đánh các quái mục tiêu gần nhân vật",
    Default = false,
    Callback = function(state)
        _G.AutoAttack = state
    end
...
v485:AddToggle({
    Name = "Bring Mob",
    Description = "Gom quái về một chỗ để cày",
    Default = false,
    Callback = function(state)
        _G.BringMonster = state
    end
