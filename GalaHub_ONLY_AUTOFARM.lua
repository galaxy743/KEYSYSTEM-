...
local vu32 = loadstring(game:HttpGet("https://raw.githubusercontent.com/tbao143/Library-ui/refs/heads/main/Redzhubui"))()
...
local v485 = v466:MakeTab({"Auto Farm", "home"})
local DummyTab = setmetatable({}, {__index = function() return function() end end})
local v484 = DummyTab
local v487 = DummyTab
local v486 = DummyTab
local v489 = DummyTab
